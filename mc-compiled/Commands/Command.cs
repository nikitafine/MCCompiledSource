...
namespace mc_compiled.Commands
{
    ...
    public static class Command
    {
        ...
        public static string StructureLoad(string name, Coord x, Coord y, Coord z, StructureRotation rotation = StructureRotation._0_degrees,
            ...
            seed == null ? $"structure load {name} {x} {y} {z} {rotation.String()} {flip} {includeEntities.ToString().ToLower()} {includeBlocks.ToString().ToLower()} {waterlogged.ToString().ToLower()} {integrity}"
            : $"structure load {name} {x} {y} {z} {rotation.String()} {flip} {includeEntities.ToString().ToLower()} {includeBlocks.ToString().ToLower()} {waterlogged.ToString().ToLower()} {integrity} {seed}";
        public static string StructureLoad(string name, Coord x, Coord y, Coord z, StructureRotation rotation = StructureRotation._0_degrees,
            ...
            seed == null ? $"structure load {name} {x} {y} {z} {rotation.String()} {flip} {animation} {animationSeconds} {includeEntities.ToString().ToLower()} {includeBlocks.ToString().ToLower()} {waterlogged.ToString().ToLower()} {integrity}"
            : $"structure load {name} {x} {y} {z} {rotation.String()} {flip} {animation} {animationSeconds} {includeEntities.ToString().ToLower()} {includeBlocks.ToString().ToLower()} {waterlogged.ToString().ToLower()} {integrity} {seed}";
